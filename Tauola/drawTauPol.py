...
#p1.GetXaxis().SetLabelFont(font)
#p1.GetXaxis().SetTitleFont(font)
p1.GetXaxis().CenterTitle()

# Y axis
p1.GetYaxis().SetTitle("P_{#tau} / " + str(p1.GetXaxis().GetBinWidth(0)))
p1.GetYaxis().SetRangeUser(-.4, .15)
p1.GetYaxis().SetTickLength(.02)
#p1.GetYaxis().SetLabelFont(font)
#p1.GetYaxis().SetTitleFont(font)
...
v1.SetLineColor(blue.GetNumber())
...
v2.SetLineStyle(ROOT.kSolid)
v2.SetLineColor(red.GetNumber())
...
stats1.SetTextColor(blue.GetNumber())
stats1.SetX2NDC(0.89)
stats1.SetY2NDC(0.88)
stats1.SetX1NDC(stats1.GetX2NDC()-0.3)
stats1.SetY1NDC(stats1.GetY2NDC()-0.24)
stats1.SetTextSize(0.03)
#stats1.SetTextFont(font)
